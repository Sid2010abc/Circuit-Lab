...
Usage: open `CircuitLab.html` in a browser or from the link at sid2010.github.io. Choose a topology, adjust battery voltage and resistances, and try burning out a bulb in each mode to compare failure behavior.
